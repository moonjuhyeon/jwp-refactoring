...
public class OrderAcceptanceStaticTest {
	...
	public static List<OrderLineItemRequest> 주문_메뉴_생성(MenuResponse menu, Long quantity) {
		return Collections.singletonList(OrderLineItemRequest.of(menu.getId(), quantity));
	}
